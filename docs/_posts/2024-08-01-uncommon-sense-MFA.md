...
Having worked for a system vendor to UHG, I have been on the receiving end of their security requirements. Authentication and access to critical systems requires multi-factor authentication. These breaches can be prevented by using MFA. Yet implementing MFA still seems to be oddly uncommon.